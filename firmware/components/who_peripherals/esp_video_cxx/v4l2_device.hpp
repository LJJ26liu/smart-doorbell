...
public:
     ...
     */
    esp_err_t set_format(enum v4l2_buf_type type,
                         uint32_t width,
                         uint32_t height,
                         uint32_t pixel_format,
                         uint32_t *actual_width = nullptr,
     ...
     */
    esp_err_t request_buffers(enum v4l2_buf_type type,
     ...
     */
    esp_err_t dequeue_buffer(enum v4l2_buf_type type,
     ...
     */
    esp_err_t enum_frame_sizes(enum v4l2_buf_type type,
                               uint32_t index,
                               uint32_t pixel_format,
     ...
     */
    esp_err_t enum_frame_intervals(enum v4l2_buf_type type,
                                   uint32_t index,
                                   uint32_t pixel_format,
                                   uint32_t width,
                                   uint32_t height,
